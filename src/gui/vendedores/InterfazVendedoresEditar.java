...
public class InterfazVendedoresEditar extends javax.swing.JFrame {
    ...
    private void botonConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConfirmarActionPerformed
        ...
        if(nombreVendedor.getText()!=null && !nombreVendedor.getText().equals("")) {nombre = nombreVendedor.getText();}
        double longitud = vendedor.getCoordenadas().getLng();
        ...
        if((ciudadVendedor.getText()!=null) && (!paisVendedor.getText().equals(""))) {ciudad = ciudadVendedor.getText();}
        String calle = vendedor.getDireccion().getCalle();
